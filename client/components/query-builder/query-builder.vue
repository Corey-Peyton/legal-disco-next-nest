<template>
  <div class="query-builder form-inline container">
    <node-tree :rule="rule" :filterTreeData="filterTreeData" :simple="simple"></node-tree>
  </div>
</template>
...
<style>
/* TODO: Still design issue is there. Need to fix. Currently this design has been taken from this path -> https://querybuilder.js.org/dev/no-bootstrap.html */
.query-builder,
.query-builder * {
  margin: 0;
  padding: 0;
